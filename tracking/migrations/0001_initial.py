...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Event'
        db.create_table('tracking_event', (
            ...
            ('related_object_id', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True)),
        ))
        db.send_create_signal('tracking', ['Event'])


    def backwards(self, orm):
        
        # Deleting model 'Event'
        db.delete_table('tracking_event')
